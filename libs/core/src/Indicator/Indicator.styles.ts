import type { CSSObject, WDesignColor, WDesignNumberSize } from '@worldprinter/wdesign-styles'
...
export default createStyles(
    (
        theme,
        { radius, color, position, offset, inline, withBorder, withLabel, zIndex }: IndicatorStylesParams,
        { size },
    ) => {

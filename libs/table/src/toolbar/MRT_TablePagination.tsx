...
export const MRT_TablePagination = <TData extends Record<string, any> = {}>({
    ...
    const showFirstLastPageButtons = totalRowCount / pageSize > 2 && paginationProps?.showFirstLastPageButtons !== false
            ...
            <Flex gap='xs'>
                ...
                {showFirstLastPageButtons && (
                    <ActionIcon
                        ...
                        disabled={lastRowIndex >= totalRowCount}
                        onClick={() => setPageIndex(Math.ceil(totalRowCount / pageSize) - 1)}
                        sx={commonActionButtonStyles}
                    >
                        <IconChevronRight />
                        <b style={{ transform: 'translate(-4px, -1.5px)' }}>|</b>

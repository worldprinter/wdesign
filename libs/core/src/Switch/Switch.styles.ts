...
export default createStyles((theme, { radius, color, labelPosition, error }: SwitchStylesParams, { size }) => {
    ...
    return {
        ...
        track: {
            ...
            border: `${rem(1)} solid ${
                error ? errorColor : theme.colorScheme === 'dark' ? theme.colors.dark[4] : theme.colors.gray[3]
            }`,

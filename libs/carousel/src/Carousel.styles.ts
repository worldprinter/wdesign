    ...
    (
        ...
        return {
            ...
            controls: {
                ...
                paddingLeft: horizontal ? getSize({ size: controlsOffset, sizes: theme.spacing }) : undefined,
                paddingRight: horizontal ? getSize({ size: controlsOffset, sizes: theme.spacing }) : undefined,
                paddingTop: !horizontal ? getSize({ size: controlsOffset, sizes: theme.spacing }) : undefined,
                paddingBottom: !horizontal ? getSize({ size: controlsOffset, sizes: theme.spacing }) : undefined,
                pointerEvents: 'none',
            },

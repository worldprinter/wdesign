...
const ruMonthsNames = ['янв.', 'февр.', 'март', 'апр.', 'май', 'июнь', 'июль', 'авг.', 'сент.', 'окт.', 'нояб.', 'дек.']
...
export function itSupportsMonthsListProps(Component: React.FC<MonthsListProps>, requiredProps?: Record<string, any>) {

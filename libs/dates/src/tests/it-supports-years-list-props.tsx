...
const defaultYearsNames = ['2020', '2021', '2022', '2023', '2024', '2025', '2026', '2027', '2028', '2029']
...
function expectYearNames(container: HTMLElement, monthNames: string[]) {
    expect(Array.from(container.querySelectorAll('table button')).map((node) => node.textContent)).toStrictEqual(
        monthNames,
    )
}

export function itSupportsYearsListProps(Component: React.FC<YearsListProps>, requiredProps?: Record<string, any>) {

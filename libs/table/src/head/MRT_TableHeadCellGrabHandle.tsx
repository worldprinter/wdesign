...
export const MRT_TableHeadCellGrabHandle = ({ column, table, tableHeadCellRef }: Props) => {
    const {
        getState,
    ...
    const handleDragEnd = (event: DragEvent<HTMLButtonElement>) => {
        ...
        if (hoveredColumn?.id === 'drop-zone') {
            ...
            setColumnOrder(reorderColumn(column, hoveredColumn as MRT_Column, columnOrder))
        }

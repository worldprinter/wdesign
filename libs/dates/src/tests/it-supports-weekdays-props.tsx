...
export function itSupportsWeekdaysProps(Component: React.FC<WeekdaysTestProps>, requiredProps?: Record<string, any>) {
    ...
    it('supports changing weekday format', () => {
        ...
        expectWeekdaysNames(['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'])
    })

...
const useStyles = createStyles(
    (
        ...
        }: { topBorderColor: string | ((theme: WDesignTheme) => string); paginationWrapBreakpoint: WDesignNumberSize },
    ) => ({
        root: {
...
> & {
    className?: string
    style?: CSSObject
    topBorderColor: string | ((theme: WDesignTheme) => string)
    fetching: boolean | undefined
    recordsLength: number | undefined
    horizontalSpacing: WDesignNumberSize | undefined

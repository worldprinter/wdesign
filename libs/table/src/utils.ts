...
import { useWDesignTheme, type WDesignTheme } from '@worldprinter/wdesign-core'
import { useMediaQuery } from '@worldprinter/wdesign-hooks'

export const useIsomorphicLayoutEffect = typeof window !== 'undefined' ? useLayoutEffect : useEffect

export function useMediaQueryStringOrFunction(mediaQuery: string | ((theme: WDesignTheme) => string) | undefined) {

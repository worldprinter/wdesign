...
export default createStyles(
    (theme, { scrollbarSize, offsetScrollbars, scrollbarHovered, hidden }: ScrollAreaStylesParams) => ({
        root: {
            overflow: 'hidden',
        },
        ...
        thumb: {
            ...
            flex: 1,
            backgroundColor:
                theme.colorScheme === 'dark' ? theme.fn.rgba(theme.white, 0.4) : theme.fn.rgba(theme.black, 0.4),

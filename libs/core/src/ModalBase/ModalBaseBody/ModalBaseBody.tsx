...
export type ModalBaseBodyProps = {} & DefaultProps & React.ComponentPropsWithoutRef<'h2'>
...
export const ModalBaseBody = forwardRef<HTMLHeadingElement, ModalBaseBodyProps>((props, ref) => {
    ...
    const { className, ...others } = useComponentDefaultProps(`${ctx.__staticSelector}Body`, defaultProps, props)

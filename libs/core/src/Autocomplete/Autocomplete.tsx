...
export const Autocomplete = forwardRef<HTMLInputElement, AutocompleteProps>(
  (props, ref) => {
    ...
    const [direction, setDirection] =
      useState<React.CSSProperties['flexDirection']>('column');
      ...
      switch (event.key) {
        ...
        case 'Enter': {
          if (filteredData[hovered] && dropdownOpened) {
            ...
            typeof onItemSubmit === 'function' &&
              onItemSubmit(filteredData[hovered]);
            setDropdownOpened(false);
          }
          break;
        }
          ...
          <SelectPopover.Target>
            ...
            >
              <Input<'input'>
                ...
                aria-owns={
                  shouldRenderDropdown ? `${inputProps.id}-items` : null
                }
                ...
                aria-activedescendant={
                  hovered >= 0 ? `${inputProps.id}-${hovered}` : null
                }
              />
            </div>
          </SelectPopover.Target>

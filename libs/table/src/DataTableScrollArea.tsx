...
import { Box, createStyles, ScrollArea } from '@worldprinter/wdesign-core'
    ...
    return {
        ...
        topShadow: {
            ...
            background: `linear-gradient(${theme.fn.rgba(theme.black, shadowGradientAlpha)}, ${theme.fn.rgba(
                theme.black,
                0,
            )}), linear-gradient(${theme.fn.rgba(theme.black, shadowGradientAlpha)}, ${theme.fn.rgba(
                theme.black,
                0,
            )} 30%)`,
        },
        ...
        bottomShadow: {
            ...
            background: `linear-gradient(${theme.fn.rgba(theme.black, 0)}, ${theme.fn.rgba(
                theme.black,
                shadowGradientAlpha,
            )}), linear-gradient(${theme.fn.rgba(theme.black, 0)} 30%, ${theme.fn.rgba(
                theme.black,
                shadowGradientAlpha,
            )})`,
        },

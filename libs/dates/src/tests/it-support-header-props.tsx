...
export function itSupportsHeaderProps(Component: React.FC<HeaderTestProps>, requiredProps?: Record<string, any>) {
    ...
    it('supports nextLabel and previousLabel props', () => {
        ...
        expect(container.querySelector('[data-previous]')).toHaveAttribute('aria-label', 'test-previous-label')
    })
    ...
    it('calls onLevelClick when level control is clicked', async () => {
        ...
        render(
            <Component
                {...requiredProps}
                levelControlAriaLabel='click me'
                onLevelClick={spy}
            />,
        )

...
export const _Card = forwardRef<HTMLDivElement, CardProps>((props, ref) => {
    const { className, padding, radius, children, unstyled, variant, ...others } = useComponentDefaultProps(
        'Card',
        defaultProps,
        props,
    )
...
export const Card = createPolymorphicComponent<'div', CardProps, { Section: typeof CardSection }>(_Card)

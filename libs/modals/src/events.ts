...
export const [useModalsEvents, createEvent] = createUseExternalEvents<ModalsEvents>('mantine-modals')

export const openModal = createEvent('openModal')
export const closeModal = createEvent('closeModal')
export const closeContextModal: ModalsEvents['closeContextModal'] = <TKey extends MantineModal>(id: TKey) =>

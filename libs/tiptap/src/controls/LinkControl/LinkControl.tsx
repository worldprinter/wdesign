...
>((props, ref) => {
  const { icon, popoverProps, disableTooltips, ...others } =
    useComponentDefaultProps('RichTextEditorLinkControl', defaultProps, props);

  const { editor, labels, classNames, styles, unstyled, variant } =
          ...
          <TextInput
            ...
            rightSection={
              <Tooltip
                label={
                  external
                    ? labels.linkEditorExternalLink
                    : labels.linkEditorInternalLink
                }

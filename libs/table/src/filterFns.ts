...
const endsWith = <TData extends Record<string, any> = {}>(row: Row<TData>, id: string, filterValue: string | number) =>
    row
        .getValue<string | number>(id)
        .toString()
        .toLowerCase()
...
const equals = <TData extends Record<string, any> = {}>(row: Row<TData>, id: string, filterValue: string | number) =>
    row.getValue<string | number>(id).toString().toLowerCase().trim() === filterValue.toString().toLowerCase().trim()

equals.autoRemove = (val: any) => !val

const notEquals = <TData extends Record<string, any> = {}>(row: Row<TData>, id: string, filterValue: string | number) =>
    row.getValue<string | number>(id).toString().toLowerCase().trim() !== filterValue.toString().toLowerCase().trim()
...
const lessThan = <TData extends Record<string, any> = {}>(row: Row<TData>, id: string, filterValue: string | number) =>
    !isNaN(+filterValue) && !isNaN(+row.getValue<string | number>(id))
        ? +row.getValue<string | number>(id) < +filterValue
        : row.getValue<string | number>(id).toString().toLowerCase().trim() <
          filterValue.toString().toLowerCase().trim()
...
const empty = <TData extends Record<string, any> = {}>(row: Row<TData>, id: string, _filterValue: string | number) =>
    !row.getValue<string | number>(id).toString().trim()

empty.autoRemove = (val: any) => !val

const notEmpty = <TData extends Record<string, any> = {}>(row: Row<TData>, id: string, _filterValue: string | number) =>
    !!row.getValue<string | number>(id).toString().trim()
